...
const char *ssid = "Honor"; //nombre de usuario WIFI
const char *password = "nata1234"; //y su contraseña.
...
void bucle(){
    ...
    porcentajeHumedad = map(lectura, 1024, 0, 0, 165);//conversion de analogRead a porcentaje de humedad
    ...
    lecturaTemperaturaHumedadAmbiente(h,t); 
    LecturaHumedad(porcentajeHumedad);//se hace lectura de humedad del suelo
...
void lecturaTemperaturaHumedadAmbiente(float h,float t)
{
